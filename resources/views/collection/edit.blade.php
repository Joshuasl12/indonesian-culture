...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('update.collection', $collection->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="nama">Nama</label>
                    <input type="text" name="nama" value="{{ $collection->nama }}" class="form-control" id="nama" 
                        required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="detail" id="detail" cols="30" rows="3"
                         required>{{ $collection->detail }}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="3d_file" type="file" class="form-control" id="3d_file" >
                </div>
